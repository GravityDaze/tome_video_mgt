    ...
    >
      ...
      >
        <el-form-item label="上级区域" prop="parentName">
          <el-input
            v-model.trim="areaForm.parentName"
            placeholder="请选择父菜单"
            disabled
          ></el-input>
        </el-form-item>
        <el-form-item label="区域名称" prop="name">
          <el-input
            v-model.trim="areaForm.name"
            placeholder="请输入区域名称"
          ></el-input>
        </el-form-item>
        <el-form-item label="标准区域码" prop="code">
          <el-input
            v-model.trim="areaForm.code"
            placeholder="请输入区域码"
          ></el-input>
        </el-form-item>
        <el-form-item label="区域级别" prop="level">
          <el-select v-model="areaForm.level">
            <el-option
              v-for="(value, key) in areaMap.values()"
              :key="key"
              :label="value"
              :value="key"
            ></el-option>
        ...
        <el-form-item
          v-show="areaForm.level === 0 && areaForm.level !== ''"
          label="国际电话区码"
        >
          <el-input
            v-model.trim="areaForm.phoneCode"
            placeholder="请输入国际电话区码"
          ></el-input>
        </el-form-item>
        <el-form-item label="经纬度" prop="lonLat">
          <el-input
            v-model.trim="areaForm.lonLat"
            placeholder="请输入经纬度"
          ></el-input>
        </el-form-item>
        <el-form-item label="首字母" prop="initial">
          <el-input
            v-model.trim="areaForm.initial"
            placeholder="请输入首字母"
          ></el-input>
        </el-form-item>
        <el-form-item label="简拼" prop="simpleSpell">
          <el-input
            v-model.trim="areaForm.simpleSpell"
            placeholder="请输入简拼"
          ></el-input>
        </el-form-item>
        <el-form-item label="全拼" prop="fullSpell">
          <el-input
            v-model.trim="areaForm.fullSpell"
            placeholder="请输入全拼"
          ></el-input>
        </el-form-item>
        <el-form-item>
  ...
  data() {
    return {
      ...
      rules: Object.freeze({
        ...
        simpleSpell: [
          { required: true, message: "请输入简拼", trigger: "blur" },
        ],
